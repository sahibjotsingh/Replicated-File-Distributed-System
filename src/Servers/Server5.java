...
public class Server5 extends UnicastRemoteObject implements RMIInterface
{
    public boolean readAllowed=true;
    public boolean writeAllowed=true;
    String portNumber[]={"5001", "5002", "5003", "5004"};
    String IPaddress[]={"localhost", "localhost", "localhost", "localhost"};
    String serverName[]={"server1", "server2", "server3", "server4"};
    String filePath = "D:\\Server files\\Server5\\textfile.txt";
    protected Server5() throws RemoteException, NotBoundException, MalformedURLException 
    {
        super();
    }
    ...
    public static void main(String[] args)
    {
        try 
        {
            ...
            registry.rebind("server5", new Server5());
