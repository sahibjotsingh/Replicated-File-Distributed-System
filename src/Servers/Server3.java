...
public class Server3 extends UnicastRemoteObject implements RMIInterface
{
    ...
    String portNumber[]={"5001", "5002", "5004", "5005"};
    String IPaddress[]={"localhost", "localhost", "localhost", "localhost"};
    String serverName[]={"server1", "server2", "server4", "server5"};
    String filePath = "D:\\Server files\\Server3\\textfile.txt";
    protected Server3() throws RemoteException, NotBoundException, MalformedURLException 
    {
        super();
    }
    ...
    public static void main(String[] args)
    {
        try 
        {
            ...
            registry.rebind("server3", new Server3());
